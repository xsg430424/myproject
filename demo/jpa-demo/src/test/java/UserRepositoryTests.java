import com.jinjue.demo.jpa.JpaDemoApplication;
import com.jinjue.demo.jpa.entity.User;
import com.jinjue.demo.jpa.repository.UserRepository;
...
public class UserRepositoryTests {
	...
	@Test
	public void testfindUsersByUserNameIsLike() {
		String username="a";
		List<User> users=userRepository.findUsersByUserNameIsLike(username);
